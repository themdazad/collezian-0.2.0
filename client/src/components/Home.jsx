...
const Home = () => {
    ...
    return (
        <>
        <div className="w-full grid justify-items-center my-16" >
                <Carousel className=" aspect-[2.73/1]  " leftControl=" " rightControl=" ">
                ...
                <Button className="items-center p-6" color="primary" variant="flat" startContent={<GoPeople />}>
