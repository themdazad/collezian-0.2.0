  ...
  return (
    <Footer container>
      <div className="w-full text-center mx-[5%]">
        ...
        <p>Designed and Developed with <span className="text-red-600">❤</span> by <a className=" text-sky-600" target="_blank" href="https://www.instagram.com/the_mdazad/">Azad</a></p>
      </div>
    </Footer>
  );
}
