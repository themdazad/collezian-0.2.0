    ...
    <Footer container>
      <div className="w-full text-center ">
        ...
        <span className="flex max-sm:justify-center text-3xl gap-4 my-4">
          ...
          <a className="font-semibold" target="_blank" href="https://www.instagram.com/the_mdazad/"><FaXTwitter /></a>
          <a className="font-semibold" target="_blank" href="https://www.instagram.com/the_mdazad/"><TfiYoutube  /></a>
          <a className="font-semibold" target="_blank" href="https://www.instagram.com/the_mdazad/"><FaWhatsapp  /></a>
        </span>
